...
public class Abteilung {
	...
	private Mitarbeiter[] mitarb_liste;
	 ...
	 * @param abt_leiter
	 */
	public Abteilung(int id, String name, Mitarbeiter[] mitarb_liste) {
		this.id = id;
		this.name = name;
	 ...
	 * @param mitarb_liste
	 */
	public Abteilung(int id, String name, String abt_leiter, Mitarbeiter[] mitarb_liste) {
		this.id = id;
		this.name = name;
	 ...
	 * @return mitarb_liste
	 */
	public Mitarbeiter[] getMitarb_liste() {
		return mitarb_liste;
	}
	 ...
	 * @param mitarb_liste
	 */
	public void setMitarb_liste(Mitarbeiter[] mitarb_liste) {
		this.mitarb_liste = mitarb_liste;
	}
